...
[externalio](https://github.com/DASDAE/externalio) is a package that allows users to plug in their own
...
[dasclients](https://github.com/DASDAE/dasclients) is a package ----with description to add---

[MultiResViewer](https://github.com/DASDAE/MultiResViewer) is a package that enables 
...
[SpoolProcessing](https://github.com/DASDAE/SpoolProcessing) is a package ---with description to add----- 
...
Additionally, relevant points of contact for each repository are listed [here](points-of-contact.md).
